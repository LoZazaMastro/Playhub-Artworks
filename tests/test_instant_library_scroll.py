...
class InstantLibraryScrollTests(unittest.TestCase):
    ...
    def test_patch_is_scoped_and_reversible(self):
        ...
        self.assertIn("visibleBottomEdge(scroller, game, scrollRect) - gameRect.height", source)
        self.assertIn("bottomAlignedGame", source)
        ...
        self.assertIn("removeEventListener('scroll'", source)
