...
fs.writeFileSync(path.join(root,'dist/build-info.json'),JSON.stringify({version:'1.1.4',build:'1.1.4-hotfix.2',builder:'offline-typescript',typescript:ts.version,
